    ...
    <section className="mb-12 lg:mb-24">
      <div className="container mx-auto">
        <div className="flex flex-col min-h-[480px] lg:space-x-20 lg:flex-row ">
          <div className="flex flex-1 space-x-6 items-center lg:space-x-12 ">
            {/* Images */}
            <div
          ...
          {/* text */}
          <div
            className="flex flex-1 flex-col items-start justify-center mt-6 lg:mt-0 "
            data-aos="fade-left"
            data-aos-offset="400"
          >
            ...
            <p className=" font-secondary mb-6 ">
              ...
              temporibus numquam culpa. Quisquam voluptatibus dignissimos
              nesciunt deserunt dolores aperiam architecto.
            </p>
